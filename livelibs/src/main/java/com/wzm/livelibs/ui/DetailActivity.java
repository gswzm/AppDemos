...
import com.wzm.livelibs.listener.SampleListener;
import com.wzm.livelibs.view.LandLayoutVideo;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        gsyVideoOption.setThumbImageView(imageView)
                ...
                .setSeekRatio(1)
                .setUrl(getIntent().getStringExtra("liveUrl"))
        ...
        detailPlayer.getFullscreenButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                detailPlayer.startWindowFullscreen(DetailActivity.this, true, true);
            }
        });
