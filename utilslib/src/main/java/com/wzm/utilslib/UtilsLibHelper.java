package com.wzm.utilslib;

import android.app.Application;
import android.content.Context;

import com.wzm.utilslib.crash.MyCrashHandler;
...
public class UtilsLibHelper {
    /**
     * 单列模式
     **/
    private static UtilsLibHelper mUtilsLibHelper = null;

    /**
     * 构造函数私有化
     **/
    private UtilsLibHelper() {
    }

    /**
     * 公有的静态函数，对外暴露获取单例对象的接口
     **/
    public static UtilsLibHelper getInstance() {
        if (mUtilsLibHelper == null) {
            synchronized (UtilsLibHelper.class) {
                if (mUtilsLibHelper == null) {
                    mUtilsLibHelper = new UtilsLibHelper();
                }
            }
        }
        return mUtilsLibHelper;
    }
     ...
     * @param context
     */
    public void init(Application context, String url){
        //错误日志本地打印
...
//        params.put("token", AppConstant.APPID);
